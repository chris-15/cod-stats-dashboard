        ...
        <>
          ...
          <div className=" grid grid-cols-1 space-y-4">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
              <div className="grid grid-cols-2 bg-sidebar border border-[#444444] rounded-lg divide-x divide-[#444444] ">
                <div>
              ...
              <div className="hidden xs:flex flex-col justify-between space-y-4 xl:space-y-2">
                ...
                <div className="bg-sidebar border border-[#444444] rounded-lg">
